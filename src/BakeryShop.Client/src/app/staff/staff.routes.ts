...
import {CurrencyManagementPageComponent} from "./currency-management-page/currency-management-page.component";
...
export const routes: Routes = [
  ...
  { path: 'currencies', component: CurrencyManagementPageComponent }
]
